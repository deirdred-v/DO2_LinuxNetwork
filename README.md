...
1. [Chapter I](#chapter-i) \
   1.1. [ipcalc tool](#ipcalc-tool) \
   1.2. [Static routing between two machines](#part-2-static-routing-between-two-machines) \
   1.3. [iperf3 utility](#part-3-iperf3-utility) \
   1.4. [Network firewall](#part-4-network-firewall) \
   1.5. [Static network routing](#part-5-static-network-routing) \
   1.6. [Dynamic IP configuration using DHCP](#part-6-dynamic-ip-configuration-using-dhcp) \
   1.7. [NAT](#part-7-nat) \
   1.8. [Bonus. Introduction to SSH Tunnels](#part-8-bonus-introduction-to-ssh-tunnels)


## Chapter I

As a result of the work should provide a report with completed tasks. Each part of the task describe what should be added to the report once it has been completed. This can be answers to questions, screenshots, etc.
